"""Jailbreak SHIELD — defensive only."""
import re
P=[r'(?i)\bDAN\b',r'(?i)\bignore\b.*\binstructions?\b',r'(?i)\bpretend\b',r'(?i)\bjailbreak\b']
D=[(r'(?i)\b(create|write)\b.*\b(malware|virus|ransomware)\b','MALWARE')]
